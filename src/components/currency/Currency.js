...
class Currency extends React.Component {
  ...
  constructor (props) {
    ...
    this.handleSetCurrencyInputCursor = this._setCurrencyInputCursor.bind(this)
    this.handleCurrencyFilterInput = this._currencyFilterInput.bind(this)
    this._filterCurrencies = this._filterCurrencies.bind(this)
    this.handleOnKeyDown = this._onKeyDown.bind(this)
  ...
  _commitSelection () {
    ...
    const currency = this.state.currencies.filter((curr, index) => {
      ...
      >
        ...
        >
          <input
            ...
            ref='currencyInput'
            onFocus={this.handleSetCurrencyInputCursor}
            onClick={this.handleSetCurrencyInputCursor}
            onChange={this.handleCurrencyFilterInput}
